...
import com.nhansen.bookproject.activity.LoginActivity;
import com.nhansen.bookproject.database.DbHelper;
import com.nhansen.bookproject.database.UserReadWriteException;
...
public class ApplicationManager extends Application {
     ...
     *
     * @throws com.nhansen.bookproject.database.UserReadWriteException if there is no active user
     * @return application context
     */
